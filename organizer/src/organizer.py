...
parser.add_argument(
    "--dry-run",
    action="store_true",
    help="Simulate file moves without changing anything",
)
...
for filename in os.listdir(download_folder):
    ...
    # -------------------------------------------------
    # Time based logic for "up to 1w old waiting period"
    # -------------------------------------------------
    ...
    if (
        "screenshot" in filename.lower() or "captura" in filename.lower()
    ) and file_extension in file_types["_Images"]:
